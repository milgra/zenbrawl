    ...
    void			physics2_set_gravity( mtvec_t* masses , v2_t gravity , float delta );
    void            physics2_set_distances( mtvec_t* dguards , float delta );
    void            physics2_set_angles( mtvec_t* aguards );
    void 			physics2_set_positions( mtvec_t* masses , surfaces_t* surfaces , float delta );
